...
//			log.info(code.toString());
	...
	public String getImageRandom(){
		if (systemSetting == null || systemSetting.getImagesList() == null || systemSetting.getImagesList().isEmpty()){
...
//	}
	...
	public List<String> getCatalogsById(String catalogID) {
		...
		if (SystemManager.catalogs == null || SystemManager.catalogs.isEmpty()){
			return null;
		}
